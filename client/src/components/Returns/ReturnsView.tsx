...
export const ReturnsView: React.FC<ReturnsViewProps> = ({
  ...
  const getReasonBadge = (reason: ReturnItem['reason']) => {
    switch (reason) {
      case 'DEFECTIVE':
        return <span className="px-2.5 py-1 text-[10px] font-bold bg-rose-50 text-rose-700 rounded-full ring-1 ring-rose-200">Defective</span>;
      case 'DAMAGED':
        return <span className="px-2.5 py-1 text-[10px] font-bold bg-amber-50 text-amber-700 rounded-full ring-1 ring-amber-200">Damaged</span>;
      case 'WRONG_ITEM':
        return <span className="px-2.5 py-1 text-[10px] font-bold bg-blue-50 text-blue-700 rounded-full ring-1 ring-blue-200">Wrong Item</span>;
      case 'CUSTOMER_CHANGE_OF_MIND':
        return <span className="px-2.5 py-1 text-[10px] font-bold bg-purple-50 text-purple-700 rounded-full ring-1 ring-purple-200">Change of Mind</span>;
      default:
        return <span className="px-2.5 py-1 text-[10px] font-bold bg-slate-100 text-slate-700 rounded-full ring-1 ring-slate-200">Other</span>;
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        {onOpenProcessReturn && (
          <button
            ...
            className="px-4 py-2.5 bg-rose-600 hover:bg-rose-700 text-white rounded-2xl text-xs sm:text-sm font-bold shadow-sm transition-colors flex items-center justify-center gap-2"
          >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-4">
        <div className="group p-4 sm:p-5 bg-white rounded-3xl ring-1 ring-slate-200/80 shadow-sm hover:shadow-xl hover:shadow-rose-100/50 hover:ring-rose-300/60 hover:-translate-y-1 transition-all duration-300">
        ...
        <div className="group p-4 sm:p-5 bg-white rounded-3xl ring-1 ring-slate-200/80 shadow-sm hover:shadow-xl hover:shadow-[var(--accent-color-light)] hover:ring-[var(--accent-color-light)] hover:-translate-y-1 transition-all duration-300">
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">
              Returns Processed
            </span>
        ...
        <div className="group p-4 sm:p-5 bg-white rounded-3xl ring-1 ring-slate-200/80 shadow-sm hover:shadow-xl hover:shadow-emerald-100/50 hover:ring-emerald-300/60 hover:-translate-y-1 transition-all duration-300">
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">
              Items Restocked
            </span>
        ...
        <div className="group p-4 sm:p-5 bg-white rounded-3xl ring-1 ring-slate-200/80 shadow-sm hover:shadow-xl hover:shadow-amber-100/50 hover:ring-amber-300/60 hover:-translate-y-1 transition-all duration-300">
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">
              Defects & Damaged
            </span>
      ...
      <div className="p-4 sm:p-6 bg-white rounded-3xl ring-1 ring-slate-200/80 shadow-sm flex flex-col md:flex-row gap-3 items-center justify-between">
      ...
      <div className="bg-white rounded-3xl ring-1 ring-slate-200/80 shadow-sm overflow-hidden">
        {filteredReturns.length === 0 ? (
          <div className="p-12 text-center">
            <div className="w-12 h-12 rounded-2xl bg-rose-50 border border-rose-100 flex items-center justify-center text-rose-500 mx-auto mb-3 shadow-sm">
                ...
                <div key={ret.id} className="transition-colors hover:bg-slate-50/50">
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between sm:justify-end gap-4 pl-12 sm:pl-0">
                      ...
                      <div className="w-7 h-7 rounded-xl bg-slate-100 flex items-center justify-center text-slate-500 transition-transform">
                         ...
                         <table className="w-full text-xs text-left border-collapse">
                           ...
                           <tbody className="divide-y divide-slate-100 text-slate-700">
                             {ret.items.map((item, idx) => (
                                <tr key={idx} className="hover:bg-[var(--accent-color-light)]">
