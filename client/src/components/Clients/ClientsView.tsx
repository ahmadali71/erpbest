          ...
          filteredClients.map(client => {
            ...
            const hasDue = client.outstandingBalance > 0;
             ...
             return (
               <div
                 key={client.id}
                 className="bg-white p-5 sm:p-6 rounded-3xl ring-1 ring-slate-200/80 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 space-y-3"
               >
                <div className="flex items-start justify-between gap-2">
                  ...
                  {hasDue ? (
                    ...
                    <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-medium bg-emerald-100 text-emerald-700 ring-1 ring-emerald-300/60">
            ...
            <tbody className="divide-y divide-slate-100 text-slate-700">
              {filteredClients.length === 0 ? (
                ...
                filteredClients.map(client => {
                  ...
                  return (
                    <tr key={client.id} className="hover:bg-[var(--accent-color-light)] transition-colors">
                      {/* Name & Company */}
