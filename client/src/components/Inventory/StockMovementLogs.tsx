...
export const StockMovementLogs: React.FC = () => {
  ...
  const getBadge = (type: StockMovementType) => {
    ...
    if (type === 'SALE') {
      return (
        <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-bold bg-[var(--accent-color-light)] text-[var(--accent-color-dark)] ring-1 ring-[var(--accent-color-light)]">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-xs text-left border-collapse">
            <thead className="bg-slate-50/80 text-slate-500 uppercase text-[10px] font-extrabold tracking-wider">
              <tr>
                <th className="px-5 py-3.5 border-b border-slate-200 font-semibold">Date & Time</th>
                <th className="px-5 py-3.5 border-b border-slate-200 font-semibold">Product / SKU</th>
                <th className="px-5 py-3.5 border-b border-slate-200 font-semibold">Event Type</th>
                <th className="px-5 py-3.5 border-b border-slate-200 font-semibold">Quantity Changed</th>
                <th className="px-5 py-3.5 border-b border-slate-200 font-semibold">Stock Balance</th>
                <th className="px-5 py-3.5 border-b border-slate-200 font-semibold">Reference / Notes</th>
              </tr>
            </thead>
