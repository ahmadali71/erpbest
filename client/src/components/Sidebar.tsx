      ...
      <div className="p-3 border-t border-slate-100 flex flex-col gap-2 bg-slate-50/60">
        {onLogout && (
          <button
            ...
            className="flex items-center justify-center gap-2 px-3 py-1.5 text-xs font-semibold text-red-600 hover:text-red-700 hover:bg-red-50 rounded-xl transition-colors w-full"
            title="Logout"
          >
