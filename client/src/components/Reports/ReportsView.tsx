    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-5 sm:p-6 rounded-3xl ring-1 ring-slate-200/80 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            onClick={exportToCSV}
            className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-2xl text-xs font-semibold transition-colors flex items-center gap-1.5"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-5 sm:p-6 rounded-3xl ring-1 ring-slate-200/80 shadow-sm border-l-4 border-l-emerald-500">
      ...
      <div className="bg-white rounded-3xl ring-1 ring-slate-200/80 shadow-sm overflow-hidden">
        ...
        {reportTab === 'pnl' && (
          <div className="p-6 sm:p-8 space-y-6">
            <div className="max-w-3xl mx-auto bg-slate-50/50 p-6 sm:p-8 rounded-3xl ring-1 ring-slate-200/80 shadow-sm space-y-4">
          ...
          <div className="p-6 sm:p-8 grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
            ...
            <div className="space-y-3">
              ...
              {paymentMethodData.map((m, idx) => (
                 <div key={m.name} className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl ring-1 ring-slate-200/60">
