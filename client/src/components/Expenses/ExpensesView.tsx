  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
        ...
        <div className="bg-white p-5 sm:p-6 rounded-3xl ring-1 ring-slate-200/80 shadow-sm flex items-center justify-between">
          ...
          <button
            ...
            className="px-3 py-1.5 bg-[var(--accent-color)] hover:bg-[var(--accent-color-dark)] text-white rounded-2xl text-xs font-semibold shadow-sm transition-colors flex items-center gap-1"
          >
      ...
      <div className="bg-white p-5 sm:p-6 rounded-3xl ring-1 ring-slate-200/80 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div className="flex flex-wrap items-center gap-2 flex-1">
          ...
          <select
            ...
            className="px-3 py-1.5 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-700 font-medium outline-none focus:border-[var(--accent-color)] focus:ring-2 focus:ring-[var(--accent-color-light)] transition-all"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            {filteredExpenses.length === 0 ? (
              ...
              filteredExpenses.map(expense => {
                ...
                return (
                  <div
                    key={expense.id}
                    className="bg-white p-5 sm:p-6 rounded-3xl ring-1 ring-slate-200/80 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all space-y-2.5"
                  >
                    ...
                    <div className="flex items-center justify-between pt-2 border-t border-slate-100">
                      ...
                      <span className="px-2 py-0.5 bg-slate-100 text-slate-700 rounded-full text-[10px] font-medium ring-1 ring-slate-300/60">
                        {expense.category}
                      </span>
                  ...
                  {filteredExpenses.length === 0 ? (
                    ...
                    filteredExpenses.map(expense => {
                      const formattedDate = new Date(expense.date).toLocaleDateString('en-US', {
                       ...
                       return (
                         <tr key={expense.id} className="hover:bg-[var(--accent-color-light)] transition-colors">
        ...
        <div className="bg-white rounded-3xl ring-1 ring-slate-200/80 shadow-sm flex flex-col overflow-hidden">
