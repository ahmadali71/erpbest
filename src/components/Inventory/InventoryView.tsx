  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
        ...
        <div
          className={`p-4 rounded-xl border shadow-xs flex items-center justify-between transition-all ${
        ...
        >
          ...
          <button
            ...
            className="px-3 py-1.5 bg-amber-600 hover:bg-amber-700 text-white rounded-lg text-xs font-semibold shadow-xs transition-colors flex items-center gap-1"
          >
                ...
                filteredProducts.map(product => {
                  ...
                  return (
                    <tr key={product.id} className="hover:bg-slate-50/80 transition-colors">
                      ...
                      {/* Category */}
                      <td className="px-5 py-3.5">
                        <span className="px-2.5 py-0.5 bg-slate-100 text-slate-700 rounded-md text-[11px] font-medium">
                          {product.category}
                        </span>
                      </td>
