              ...
              <button
                ...
                className={`relative flex flex-col justify-between p-3.5 rounded-2xl border text-left transition-all duration-200 group ${
                  isOutOfStock
                    ...
                    : inCart
                     ? 'bg-[var(--accent-color)]/60 border-[var(--accent-color-light)] ring-2 ring-[var(--accent-color-light)] shadow-xs scale-[1.01]'
                     : 'bg-white border-slate-200/90 hover:border-[var(--accent-color-light)] hover:shadow-md hover:-translate-y-0.5'
                }`}
              >
                {/* Top SKU & Badge */}
