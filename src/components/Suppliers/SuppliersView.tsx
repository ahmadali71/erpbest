          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4 sm:p-6">
            {filteredSuppliers.length === 0 ? (
              ...
              filteredSuppliers.map(sup => (
                <div
                  key={sup.id}
                  className="bg-white p-5 rounded-xl border border-slate-200 hover:border-[var(--accent-color-light)] transition-all shadow-2xs flex flex-col justify-between"
                >
                  <div>
                  ...
                  <div className="mt-5 pt-3 border-t border-slate-100 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1">
                      <button
                        ...
                        className="px-2.5 py-1 text-xs font-semibold text-[var(--accent-color)] hover:bg-[var(--accent-color-light)] rounded-lg transition-colors"
                      >
                        Edit
                      </button>
                      <button
